  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col items-center py-12 px-4 lg:px-20">
      ...
      <div className="w-full max-w-6xl rounded-lg overflow-hidden shadow-xl mb-10">
        <Suspense
          fallback={
            <div className="flex justify-center items-center h-80 lg:h-[500px]">
              <div role="status">
                <svg
                  aria-hidden="true"
      ...
      >
        ...
        >
          <LazyLoadImage
            src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' fill='none' viewBox='0 0 24 24' stroke='%23ffffff' stroke-width='2'%3E%3Cpath stroke-linecap='round' stroke-linejoin='round' d='M5 10l7-7m0 0l7 7m-7-7v18'/%3E%3C/svg%3E"
            alt="Arrow Icon"
            effect="blur"
            className="w-6 h-6"
          />
